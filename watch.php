            ...
            <div class="embed-responsive embed-responsive-16by9">
              ...
              <?php else: ?>
                ...
                <div class="embed-responsive embed-responsive-16by9">
                  ...
                  <br>
                  <button onclick="playVid()" type="button" id="play" class="btn btn-danger">เล่นวิดีโอ</button>
                  <button onclick="pauseVid()" type="button" id="pause" class="btn btn-warning">หยุด</button>
                  <a href="choice.php?choice_id=<?php echo $row_watch['choice_id'];?>&user_id=<?php echo $_SESSION['UserID'];?>&aff=aff" type="button" class="btn btn-primary" id="next" style="display: none;">ทำแบบทดสอบ</a>
                  <br> 
